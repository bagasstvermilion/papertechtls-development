        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><span id="vJudulForm1"><b>UPLOAD DATA RAPEL</b></span></h3>
                    <div class="card-tools">
                        ...
                        <a href="<?php echo base_url(); ?>index.php/plan/order" class="btn btn-warning btn-sm">Back to List</a>
                ...
                <div class="card-body" style="background-color:;">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <form action="<?php echo base_url(); ?>index.php/rapel/uplod" id="frm1" method="post" enctype="multipart/form-data" accept-charset="utf-8">

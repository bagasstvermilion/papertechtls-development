    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><span id="vJudulForm1"><b>Documents</b></span></h3>
          ...
          <div class="row">
            <div class="col-lg-2" style="display:;">
              ...
              <div class="input-group">
                <select name="txtCari1" id="txtCari1" class="form-control form-control-sm">
                  <!-- <option value="">All</option> -->
                  <?php
                  $sql = "SELECT * from doctype where isactive='yes' order by id";
            ...
            <div class="col-lg-2" style="display:;">
              ...
              <div class="input-group">
                <select name="txtCari2" id="txtCari2" class="form-control form-control-sm">
                  <option value="">All</option>
                  <?php
                  $sql = "SELECT REPLACE(status, 'no_reminder', 'no reminder') AS status, status AS status1 FROM document GROUP BY status";
                  $rs = $this->db->query($sql);
                  if ($rs->num_rows() > 0) {
                    $i = 0;
                    foreach ($rs->result_array() as $row) {
            ...
            <div class="col-lg-12">
              <table id="tabel1" class="table table-striped table-bordered table-responsive-md table-hover" style="font-size: 14px">
                <thead>
                  ...
                  <th class="text-center">Until<br>(Exp Date)</th>
...
<script>
  ...
  var dataUrl = '<?php echo base_url(); ?>index.php/document/data'; //'<?php echo base_url(); ?>index.php/Unpackingpxpdata/blank_data';
  ...
  function getDtTable() {
    ...
    dataUrl1 = '<?php echo base_url(); ?>index.php/document/data';

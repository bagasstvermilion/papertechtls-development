<style type="text/css">
    ...
    table#tabel2.dataTable tbody tr:hover {
        background-color: #ffa;
    }

    table#tabel2.dataTable tbody tr:hover>.sorting_1 {
        background-color: #ffa;
    }
</style>
...
<section class="content">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><span id="vJudulForm1"><b>CS View</b></span></h3>
                        ...
                        <div class="col-lg-12">
                            <table id="tabel1" class="table table-striped table-bordered table-responsive-md table-hover" style="font-size: 14px">
                                <thead>
                                    ...
                                    <th class="text-center">Loading Dock</th>
                                    <th class="text-center">Loading Status</th>
                                    <th class="text-center">Timbang Kosong</th>
                                    <th class="text-center">Timbang Isi</th>
                                    <th class="text-center">Netto</th>
                                    <th class="text-center">Status Muatan</th>
                                    <th class="text-center">Remark Security</th>
                                    <th class="text-center">Remark WH</th>
                                </thead>
    ...
    <?php require_once("cs_view_detail.php");
    ?>
...
<script>
    ...
    function getDtTable() {
        ...
        dataUrl1 = '<?php echo base_url(); ?>index.php/cs/cs_view_data';
        dataUrl = dataUrl1 + "/" + param1 + "/" + param2; // + "/" + param3;
        //console.log(dataUrl);
        dtTable.ajax.url(dataUrl).load();
    }

    function getDtTable2(param1, param2) {
        dataUrl1 = '<?php echo base_url(); ?>index.php/cs/cs_view_data_detail';
        dataUrl = dataUrl1 + "/" + param1 + "/" + param2; // + "/" + param3;
        console.log(dataUrl);
        dtTable2.ajax.url(dataUrl).load();
    }
    ...
    function addForm(url) {
        const kkey = url.split("_");
        const no_antrean = kkey[3];
        const no_polisi = kkey[1];
        const tanggal_jadwal = kkey[2];
        const trans_no = kkey[0];

        $('#modal-form').modal('show');
        $('#modal-form .modal-title').text('Detail Tiket ' + trans_no);
        $('#modal-form #trans_no').val(trans_no);
        $('#modal-form #no_antrean').val(no_antrean);
        $('#modal-form #tanggal_jadwal').val(tanggal_jadwal);
        $('#modal-form #no_polisi').val(no_polisi);

        getDtTable2(tanggal_jadwal, no_antrean);

        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><span id="vJudulForm1"><b>FINISH UNPACKING</b></span></h3>
...
<script>
    let dtTable;
    let vmessageTop = "FINISH UNPACKING  ";
    let vJudulForm = "Unpacking PXP HML - Finish Unpacking List (Complete Case)";
    ...
    function getDtTable() {
        ...
        dataUrl1 = '<?php echo base_url(); ?>index.php/Unpackingpxpdata/get_machining_unpacking_complete';

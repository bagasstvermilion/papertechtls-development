...
class DataTables
{
    ...
    if ($this->request->get('columns') !== null) {
		...
		foreach ($this->request->get('columns') as $request_column) {
			if (
				...
				$column = isset($this->columnAliases[$column]) ? $this->columnAliases[$column] : $column;
    ...
    public function generate()
    {
        ...
        $this->request->get('draw') !== null ? $draw = $this->request->get('draw') : $draw = 0 ;
        $response->setData([
            'draw' => $draw /*$this->request->get('draw')*/,

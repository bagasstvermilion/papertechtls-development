...
class Shipmentplanupload extends CI_Controller
{
    ...
    {
        $sql = "SELECT * from machining_shipping_plan where id='$id'";
    ...
    public function destroy()
    {
        ...
        $sql = "DELETE FROM  machining_shipping_plan WHERE caseno='" . $data['caseno'] . "' and containerno='" . $data['containerno'] . "' and shippingcode='" . $data['shippingcode'] . "'";
        //$data['sql'] = $sql;
        $this->db->query($sql);
        $data1['sts'] = 'Delete success';
